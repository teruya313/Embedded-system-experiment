...
public class Kadai_5f
{
    private Hardware hardware = Hardware.getInstance(); //ハードウェアのインスタンスを取得する
    private int[] xA = new int[5]; //getMin(),getMax()での座標データ配列
    private int[] yA = new int[5]; //getMin(),getMax()での座標データ配列
    // 左下 左上 右上 右下 左下 右上 左上 右下
    private int[] xB = { 0, 0, 0, 0, 0};
    private int[] yB = { 0, 0, 0, 0, 0};
